# Escrever um artigo científico: Um guia passo-a-passo para principiantes

## Resumo
Muitos jovens investigadores enfrentam grandes dificuldades ao escrever artigos científicos e recebem pouca formação específica sobre como apresentar seu trabalho de pesquisa por escrito. No entanto, a publicação é frequentemente essencial para avançar na carreira, obter financiamento e obter qualificações académicas, ou seja, por todas essas razões. Neste guia, descrevemos os passos básicos a serem seguidos na redação de um artigo científico. Abordamos as principais seções que um artigo típico deve conter, os elementos que devem ser incluídos nessas seções e fornecemos algumas indicações para tornar o resultado final atrativo e adequado para publicação.

---

<!-- ## Introdução: estabelecendo o contexto e a relevância
A primeira seção do seu artigo científico é a introdução, onde você estabelece o contexto e a relevância do seu estudo. O objetivo dessa seção é despertar o interesse do leitor e fornecer uma visão geral do problema que você está abordando. Aqui estão alguns elementos-chave que devem ser incluídos na introdução:

1. Contextualização: apresente o campo de estudo e a importância do tema escolhido.
2. Revisão da literatura: resuma as pesquisas anteriores relevantes e destaque as lacunas de conhecimento.
3. Objetivos e hipóteses: explique claramente o objetivo do seu estudo e as hipóteses que serão testadas.
4. Metodologia: descreva brevemente a abordagem metodológica que você utilizará.

Lembre-se de que a introdução deve ser concisa e direta, fornecendo ao leitor uma visão geral clara do seu trabalho. Evite informações excessivamente detalhadas nesta seção e deixe os detalhes específicos para as seções subsequentes.
--- -->

## Começar: tarefas a serem realizadas antes de escrever uma palavra

Antes de iniciar a redação do seu artigo, é importante realizar uma série de tarefas preparatórias. Idealmente, essas tarefas já devem ter sido concluídas durante a fase de planejamento da sua pesquisa, pois elas servem como base para o projeto em que você está trabalhando. O tempo investido na preparação do protocolo do seu projeto é fundamental para a redação do artigo resultante. Nesse sentido, é provável que você já tenha realizado uma extensa revisão da literatura para compreender o estado atual do conhecimento sobre o assunto, garantindo assim a originalidade da sua pesquisa ao desenvolver o protocolo. Essa revisão da literatura pode ser uma valiosa fonte de informações para o seu artigo. Durante essa revisão, é útil fazer anotações dos pontos ou frases importantes que você pretende incluir, juntamente com as referências correspondentes. Além disso, o uso de um programa de software para gerenciar referências (há versões gratuitas ou produtos disponíveis no mercado) pode facilitar o gerenciamento do grande volume de referências que você provavelmente precisará consultar antes de selecionar os pontos mais relevantes.

## Resultados: apresentando a análise estatística e conclusões

Normalmente, você também terá os resultados finais da análise estatística dos seus dados, que servirão como base para a seção de resultados do seu artigo. Algumas representações gráficas dos seus resultados podem ser incluídas como figuras no artigo, portanto, é útil destacar as conclusões mais importantes à medida que você revisa os resultados, para garantir que nada relevante seja esquecido.

Antes de começar a escrever, é importante identificar a revista à qual pretende submeter o seu trabalho de pesquisa. Isso terá consequências para a formatação, mas, mais importante ainda, para a orientação do seu estilo de escrita, uma vez que a redação deve ser adequada ao tipo de leitor a que se destina. Por exemplo, você está escrevendo para uma revista especializada, na qual os leitores são especialistas na sua área, ou para uma revista de medicina geral, na qual os leitores podem ser especialistas de outras disciplinas? Isso terá implicações na quantidade e no tipo de informação que deve ser incluída. Além disso, a política editorial da revista-alvo também deve ser considerada. Por exemplo, em uma determinada área de especialização, algumas revistas favorecem artigos que relatam pesquisa básica, enquanto outras dão prioridade a trabalhos mais clínicos. A escolha da revista-alvo depende de vários fatores, que estão além do escopo deste artigo. No entanto, no mínimo, você deve verificar se o seu trabalho se enquadra no escopo da revista escolhida.

### Quais são as principais seções de um artigo científico?
...
A introdução deve fluir logicamente para a identificação da lacuna no conhecimento que se espera preencher. Esta é a sua oportunidade para indicar o valor acrescentado do seu estudo ou a nova informação que o seu estudo irá produzir. Os seus resultados irão alterar a prática clínica? Irão ajudar a comunidade científica em geral a chegar a um consenso sobre um tópico anteriormente controverso, fornecendo provas concretas numa ou noutra direção? Esta é a sua oportunidade de fazer um discurso de vendas para o seu artigo, nos termos apropriados, claro.
...
| Formular a sua hipótese | Presente | Formulámos a hipótese de que o medicamento A aumenta o risco de hemorragia |
...
<!-- organizar texto acima numa table de duas colunas -->
...
<!-- converter text em cikma em tabela de 2 colunas -->
